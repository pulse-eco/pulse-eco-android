...
public final class SubdivisionEdge {
    ...
    public String toString() {
        return String.format(Locale.getDefault(),
                ...
                edgeKeyApplyAsInt(_twin), edgeFaceApplyAsInt(_face),
                edgeKeyApplyAsInt(_next), edgeKeyApplyAsInt(_previous));
    }

    private Integer edgeKeyApplyAsInt(SubdivisionEdge e) {
        return e == null ? -1 : e._key;
    }

    private Integer edgeFaceApplyAsInt(SubdivisionFace e) {
        return e == null ? -1 : e._key;
    }
}
