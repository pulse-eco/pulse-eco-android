...
class CurrentlyCitySelectAdapter : RecyclerView.Adapter<CitySelectItemViewHolder>(),
...
class CitySelectItemViewHolder(view: View, citySelectListener: CitySelectListener) :
