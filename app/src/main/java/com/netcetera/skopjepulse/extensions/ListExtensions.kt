...
import com.netcetera.skopjepulse.countryCitySelector.CountryCityItem
 ...
 */
fun List<CountryItem>.transformData(checkedCityItems:HashSet<CityItem>) : ArrayList<CountryCityItem>{
  val dataTrans = ArrayList<CountryCityItem>()
  for (country in this){
